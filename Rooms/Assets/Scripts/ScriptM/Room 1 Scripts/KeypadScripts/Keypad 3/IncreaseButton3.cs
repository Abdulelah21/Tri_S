...
using UnityEngine;
using TMPro;
public class IncreaseButton3 : MonoBehaviour
{
    ...
    public void PassingKeypadInput3(int textInput)
    {
    ...
    void Update()
    {
        if (Input.GetButtonDown("Interact") && inReach)
        {
            ...
            FindObjectOfType<DecreaseButton3>().PassingKeypadInputTwo3(passingText);
